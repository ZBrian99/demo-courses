...
import { useGetStaffQuery } from '../api/usersApi';
...
const StaffPage: React.FC = () => {
	...
	const {
		...
		isFetching,
		isError,
	} = useGetStaffQuery(cleanFilters<UsersFiltersQuery>(filters));
	...
	useEffect(() => {
		dispatch(setBreadcrumbs([{ label: 'Personal', path: '/staff' }]));
	}, []);
	...
	return (
		...
		>
			...
			>
				<UsersFilters onFilterChange={handleFilterChange} showRoleFilter />
			</Box>
